...
exports.githubCreateIssueComment = exports.githubUpdateExistingIssueComment = exports.githubGetExistingIssueComments = exports.githubCreateReview = exports.githubUpdateExistingReviewComment = exports.githubGetExistingReviewComments = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    pullRequestNumber = (0, github_context_1.githubGetPullRequestNumber)();
...
function githubCreateReview(github_token, comments, event) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            SIGLogger_1.logger.debug("PR number: ".concat(pullRequestNumber, " owner: ").concat(github_1.context.repo.owner, " repo: ").concat(github_1.context.repo.repo, " event: ").concat(event));
